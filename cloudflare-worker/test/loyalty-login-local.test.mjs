...
const root = { loyalty_customers: { '101-100': { name: 'Legacy Fixture', hearts: 2, pin: '1234' }, '101-101': { name: 'Hashed Fixture', hearts: 1 }, '101-102': { name: 'Broken Credential Fixture', hearts: 4, pin: '2468' }, '101-103': { name: 'Malformed Credential Fixture', hearts: 5, pin: '1357' } }, loyalty_credentials: { '101-101': await createCredential('5678', env.LOYALTY_PIN_PEPPER), '101-102': { pinHash: 'old-but-incomplete' }, '101-103': { pinHash: '%%%not-base64%%%', salt: '%%%not-base64%%%', algorithm: 'PBKDF2-SHA512', iterations: 100000 } }, loyalty_login_attempts: {} };
