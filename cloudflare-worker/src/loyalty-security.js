...
async function createCredential(pin,pepper,now=Date.now()){if(!validPin(pin))throw Error('INVALID_PIN');const salt=out(crypto.getRandomValues(new Uint8Array(32)));return{pinHash:await derivePin(pin,salt,pepper),salt,algorithm:'PBKDF2-SHA512',iterations:ITERATIONS,version:1,failedAttempts:0,lockedUntil:0,updatedAt:now};}
...
export{ITERATIONS,MAX_FAILURES,WINDOW_MS,normalizeMembershipNumber,validPin,derivePin,timingSafeEqual,timingSafePinMatch,attemptKey,createCredential,generatePin,publicProfile};
